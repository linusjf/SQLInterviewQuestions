...
INSERT INTO spotify_daily_rankings_2017_us
  (position, trackname, artist, streams, url, rank_date)
VALUES
...
INSERT INTO spotify_worldwide_daily_song_ranking
  (position, trackname, artist, streams, url, rank_date, region)
VALUES
  (1, 'Track A', 'Artist 1', 550000, 'https://url1.com', '2017-01-01', 'US'),
  (2, 'Track B', 'Artist 2', 450000, 'https://url2.com', '2017-01-01', 'US'),
  (1, 'Track A', 'Artist 1', 530000, 'https://url1.com', '2017-01-02', 'US'),
  (1, 'Track D', 'Artist 4', 610000, 'https://url4.com', '2017-01-03', 'US'),
  (3, 'Track C', 'Artist 3', 320000, 'https://url3.com', '2017-01-03', 'US');
...
FROM
  ...
  INNER JOIN spotify_worldwide_daily_song_ranking AS wwt
    ON ust.trackname = wwt.trackname
